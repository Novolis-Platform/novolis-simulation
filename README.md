...
<p align="center">
  <img src="https://raw.githubusercontent.com/Novolis-Platform/.github/main/brand/banners/novolis-simulation.svg" width="100%" alt="novolis-simulation"/>
</p>

<p align="center">
  <strong>Worlds, clocks, humanoids</strong><br/>
  Simulation orchestration above physics — humanoids, kinematics, space combat.
</p>

<p align="center">
  <a href="https://github.com/Novolis-Platform/novolis-simulation/actions"><img src="https://img.shields.io/github/actions/workflow/status/Novolis-Platform/novolis-simulation/merge.yml?branch=main&label=merge&logo=github" alt="merge"/></a>
  <a href="https://github.com/orgs/Novolis-Platform/packages?repo_name=novolis-simulation"><img src="https://img.shields.io/badge/packages-GitHub%20Packages-0a7ea3?logo=nuget" alt="packages"/></a>
...
| `Novolis.Simulation.Humanoid.Import` | `dotnet add package Novolis.Simulation.Humanoid.Import` | [README](https://github.com/Novolis-Platform/novolis-simulation/blob/main/src/Novolis.Simulation.Humanoid.Import/README.md) |
| `Novolis.Simulation.Humanoid.Physics` | `dotnet add package Novolis.Simulation.Humanoid.Physics` | [README](https://github.com/Novolis-Platform/novolis-simulation/blob/main/src/Novolis.Simulation.Humanoid.Physics/README.md) |
| `Novolis.Simulation.Humanoid.Skinning` | `dotnet add package Novolis.Simulation.Humanoid.Skinning` | [README](https://github.com/Novolis-Platform/novolis-simulation/blob/main/src/Novolis.Simulation.Humanoid.Skinning/README.md) |
...
| `Novolis.Simulation.SpaceCombat` | `dotnet add package Novolis.Simulation.SpaceCombat` | [README](https://github.com/Novolis-Platform/novolis-simulation/blob/main/src/Novolis.Simulation.SpaceCombat/README.md) |
